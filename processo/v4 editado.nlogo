...
to go
  ...
  ask turtles [
    ...
    if any? other turtles-here [
      ...
      ; encontro endogrupo
      if [grupo] of turtle outro = grupo [
        ...
        output-print (word competitivo "-" competitivo-outro "=" diferenca-competitivo)
        ...
        output-print (word simpatico "-" simpatico-outro "=" diferenca-simpatico)
        ...
        output-print (word sociavel "-" sociavel-outro "=" diferenca-sociavel)
  ...
  if (ticks >= tempo-edital) and (ticks mod tempo-edital = 0) [
    ...
    ask ricp [
      ...
      ifelse competitivo >= emprego-c2 and simpatico >= emprego-c3 and sociavel >= emprego-c4 [
        ; competitivo
        set competitivo competitivo * taxa-autodescricao
        ; competitivo
        set simpatico simpatico * taxa-autodescricao
        ; competitivo
        set sociavel sociavel * taxa-autodescricao
        ; impede valores > 5
        if competitivo > 5 [ set competitivo 5 ]
        if simpatico > 5 [ set simpatico 5 ]
        if sociavel > 5 [ set sociavel 5 ]
        ...
        ; atualiza heterodescrição do outro grupo
        ask riep [
          set outro-competitivo outro-competitivo - outro-competitivo * taxa-heterodescricao
          set outro-simpatico outro-simpatico - outro-simpatico * taxa-heterodescricao
          set outro-sociavel outro-sociavel - outro-sociavel * taxa-heterodescricao
          ; impede valores < 0
          if outro-competitivo < 0 [ set outro-competitivo 0 ]
          if outro-simpatico < 0 [ set outro-simpatico 0 ]
          if outro-sociavel < 0 [ set outro-sociavel 0 ]
          ; avisa
          output-print (word "ricp " who " não conseguiu")
        ]
      ]
    ]
    ; ================================================
    ...
    ask riep [
      ...
      ifelse competitivo >= emprego-c2 and simpatico >= emprego-c3 and sociavel >= emprego-c4 [
        ...
        ask ricp [
          ...
          if outro-sociavel < 0 [ set outro-sociavel 0 ]
          ; avisa
          output-print (word "riep " who " não conseguiu")
        ]
      ]
    ]
  ]
