...
to cria-ricp [ agentes ]
  create-ricp agentes [
    ...
    if dinamica = "auto-hétero" [
      ...
      set dinamico random-float 5
      ; do outro
      set outro-ambicioso random-float 5
      set outro-competitivo 2.7
      set outro-simpatico 2.8
      set outro-sociavel 3
      set outro-dinamico random-float 5
    ]
    ; ==================================
    ; intervalo
    ; ==================================
...
to go
  ...
  if ticks / tempo-edital > 100 [ stop ]
